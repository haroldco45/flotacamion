# 🚛 FlotaPro — Sistema de Control de Flota Vehicular
...
Sistema web genérico de gestión de flota de vehículos, diseñado para cualquier empresa de transporte. Permite controlar mantenimientos, documentos, conductores, talleres, gastos y generar reportes mensuales por vehículo.

El nombre, ícono y datos de la empresa se configuran directamente desde la app con el botón **⚙️ Configurar**, sin necesidad de tocar el código.
...
1. Abrir el archivo `index.html` en cualquier navegador (Chrome recomendado)
2. La primera vez aparece automáticamente el modal de **configuración de empresa**
3. Ingresar el nombre de la empresa, slogan, ícono (emoji), ciudad, NIT y teléfono
4. Registrar primero: **Talleres → Conductores → Vehículos** → luego Mantenimientos y Gastos
